...
bool FCrowdyApplyEffectPinPlanTest::RunTest(const FString& Parameters)
{
	...
	TestTrue(TEXT("a string pin changed only in letter case is included"),
		CrowdyApplyEffectNodePins::ShouldIncludeOverride(false, false, nullptr, TEXT("Alice"), TEXT("alice")));
	TestFalse(TEXT("an identically spelled string pin is still omitted"),
		CrowdyApplyEffectNodePins::ShouldIncludeOverride(false, false, nullptr, TEXT("Alice"), TEXT("Alice")));
